...
router.post('/upload-profile-picture', upload.single('profilePicture'), patientController.uploadProfilePicture);

// Route for deleting profile picture
router.delete('/delete-profile-picture', patientController.deleteProfilePicture); // Changed to DELETE
